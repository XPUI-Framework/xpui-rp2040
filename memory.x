 ...
 *
 * FLASH is declared as the 2 MiB a Badger 2040 has. A Tufty 2040 has 8 MiB;
 ...
 *
 * RAM is the 256 KiB striped bank. The RP2040 has 264 KiB in total, but the
 * two 4 KiB scratch banks above it are not contiguous with the rest, so — as
 * in every RP2040 linker script — they are left out.
 */
MEMORY {
